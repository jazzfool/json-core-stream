...
impl<'a, 'de, R, const N: usize> MapAccess<'a, R, N>
where
    R: Read<'de>,
{
...
impl<'a, 'de, R, const N: usize> de::MapAccess<'de> for MapAccess<'a, R, N>
where
    R: Read<'de>,
{
    type Error = Error;
...
impl<'a, 'de, R, const N: usize> de::Deserializer<'de> for MapKey<'a, R, N>
where
    R: Read<'de>,
{
    type Error = Error;
